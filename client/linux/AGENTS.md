...
`client748/` (assets / validação Windows).

Para o **port Linux** (binários `project` / `WYD Arm64`, DXVK, touch): ver
`WYDLINUX/AGENTS.md` e o playbook `WYDLINUX/PORT.md` — não misturar com patches
em `wyd.exe nativo+patches/`.
